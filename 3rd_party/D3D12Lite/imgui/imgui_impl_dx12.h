...
struct ImGui_ImplDX12_InitInfo
{
    ...
    D3D12_CPU_DESCRIPTOR_HANDLE LegacySingleSrvCpuDescriptors[2]; // To facilitate transition from single descriptor to allocator callback, you may use those.
    D3D12_GPU_DESCRIPTOR_HANDLE LegacySingleSrvGpuDescriptors[2];
#endif
